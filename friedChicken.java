...
public class friedChicken extends AppCompatActivity {
    ...
    //constant price
    final double priceAmount = 49.99;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fried_chicken);
    ...
    public void storeOrder()
    {
        confirms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                newOrder.setFoodName("Fried Chicken");
                newOrder.setFoodPrice(priceAmount);
                newOrder.setAmount(count);

                db.insert(newOrder);

                Intent goTO = new Intent(friedChicken.this, Menu1.class);
