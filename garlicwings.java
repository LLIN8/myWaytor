...
public class garlicwings extends AppCompatActivity {

    //constant price
    final double priceAmount = 10.99;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_garlicwings);
    ...
    public void storeOrder()
    {
        confirms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                newOrder.setFoodName("Garlic Wings");
